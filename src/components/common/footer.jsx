          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className={`space-y-6 ${isVisible ? "footer-item-animate" : "opacity-0 translate-y-8"}`}>
              ...
              <p className="text-gray-600 text-sm leading-relaxed hover:text-gray-800 transition-colors duration-300">
                BioMANTHAN 2025 — the 40th International Conference at IIT Ropar (Dec 4–7, 2025) — unites global experts in biomaterials, bioprinting, tissue engineering, AI in healthcare, and traditional medicine. Join us to explore innovations shaping the future of healthcare and regenerative medicine.
              </p>
            ...
            {/* Quick Links */}
            <div className={`${isVisible ? "footer-item-animate md:pl-12" : "opacity-0 translate-y-8"}`} style={{ animationDelay: "0.1s" }}>
